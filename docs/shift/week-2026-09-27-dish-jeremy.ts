...
// שוטפים 27/09–03/10 — ירין: ג'רמי פותח את אומינו כל בוקר (א'–ו', חופש בשבת), ערבים מתחלפים בלי ג'רמי.
//   ג'רמי: א' 11:00 (סגר מוצ"ש 26/09), ב'–ו' 10:00.
//   כלל גיל נשמר ואף מתחזק: הילארי בכל ערבי אומינו כולל מוצ"ש 19:30; חופש בו' (אומינו סגורה בערב).
//   פטל בערבי פסאו, חופש בה' (טוני 19:00 + אנזו 17:00). טוני רק ה'+ו' מ-19:00.
//   נשארות 14 משמרות פסאו לג'ונתן ואנזו → 2 כפולות מינימום (חיפוש מלא): ג'ונתן בב', אנזו בה'.
//   בלי סגירה→פתיחה, אף אחד לא עובד 7 ימים.
...
const ROWS: Row[] = [
  [0, B, W.JONATHAN, "10:00", ""], [0, B, W.JEREMY, "11:00", U],
  [0, E, W.PATEL, "17:00", ""], [0, E, W.ENZO, "18:00", ""], [0, E, W.HILLARY, "18:00", U],

  [1, B, W.JONATHAN, "10:00", ""], [1, B, W.JEREMY, "10:00", U],
  [1, E, W.PATEL, "17:00", ""], [1, E, W.JONATHAN, "18:00", ""], [1, E, W.HILLARY, "18:00", U],

  [2, B, W.ENZO, "10:00", ""], [2, B, W.JEREMY, "10:00", U],
  [2, E, W.PATEL, "17:00", ""], [2, E, W.JONATHAN, "18:00", ""], [2, E, W.HILLARY, "18:00", U],

  [3, B, W.ENZO, "10:00", ""], [3, B, W.JEREMY, "10:00", U],
  [3, E, W.PATEL, "17:00", ""], [3, E, W.JONATHAN, "18:00", ""], [3, E, W.HILLARY, "18:00", U],

  [4, B, W.ENZO, "10:00", ""], [4, B, W.JEREMY, "10:00", U],
  [4, E, W.ENZO, "17:00", ""], [4, E, W.TONY, "19:00", ""], [4, E, W.HILLARY, "18:00", U],

  [5, B, W.JONATHAN, "08:00", ""], [5, B, W.JEREMY, "10:00", U], [5, B, W.ENZO, "13:00", ""],
  [5, E, W.PATEL, "17:00", ""], [5, E, W.TONY, "19:00", ""],

  [6, B, W.JONATHAN, "08:00", ""],
  [6, E, W.ENZO, "16:00", ""], [6, E, W.PATEL, "18:00", ""], [6, E, W.HILLARY, "19:30", U],
];
...
const same = (c: any, r: Row) => c.day === r[0] && c.shift === r[1] && Number(c.employee ?? 0) === r[2] && hhmm(c.planned_start) === r[3] && String(c.notes || "") === r[4];
...
Deno.serve(async (req) => {
  try {
    ...
    for (const c of after.sort((a: any, b: any) => (a.day - b.day) || byStart(a, b))) {
      (by[String(c.date).slice(0, 10)] ||= []).push(`${hhmm(c.planned_start)} ${who(c)}${String(c.notes || "").includes(U) ? " ← אומינו" : ""}`);
