...
// שוטפים 27/09–03/10 — תיקון אחרי עדכון זמינות (ירין, 25/09):
//   טוני בדרך כלל יכול רק ה'+ו' מ-19:00 → יוצא מא'+ב'; ה' ו-ו' ב-19:00.
//   אנזו במקום טוני בא' ערב (הצעת ירין).
// בלי טוני בא'+ב' נשארים 20 משמרות לג'ונתן/ג'רמי/אנזו → 18 ימי עבודה + 2 כפולות (מינימום, נבדק בחיפוש מלא):
//   ג'ונתן כפולה ב' (פתיחה + ערב), ג'רמי כפולה ד'. בלי שבוע של 7 ימים, בלי סגירה→פתיחה חוץ מג'רמי בא'.
//   פטל עובד ה' 17:00 במקום אנזו, וחופש ב-ו' (טוני 19:00 ממלא).
// Reconcile: מתאים את התאים הקיימים ל-ROWS — PATCH לתא קיים באותו יום+משמרת, יצירה/מחיקה לשאר. לא מפרסם.
...
const ROWS: Row[] = [
  ...
  [3, B, W.JEREMY, "10:00", ""], [3, B, W.ENZO, "10:00", U],
  [3, E, W.PATEL, "17:00", ""], [3, E, W.JEREMY, "18:00", ""], [3, E, W.HILLARY, "18:00", U],

  [4, B, W.JONATHAN, "10:00", ""], [4, B, W.ENZO, "10:00", U],
  [4, E, W.PATEL, "17:00", ""], [4, E, W.TONY, "19:00", ""], [4, E, W.HILLARY, "18:00", U],

  [5, B, W.JONATHAN, "08:00", ""], [5, B, W.JEREMY, "10:00", U], [5, B, W.ENZO, "13:00", ""],
  [5, E, W.HILLARY, "17:00", ""], [5, E, W.TONY, "19:00", ""],
