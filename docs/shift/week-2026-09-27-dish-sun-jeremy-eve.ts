...
// שוטפים 27/09–03/10 — חזרה לסידור שלפני התוכנית של גיל (ירין 26/09 בערב):
//   ג'רמי לא מוכן לעבור לערבים (רוצה 11+ שעות ביום) → ג'רמי שוב בבקרי אומינו, הסרילנקי נדחה.
//   פטל חוזר לערבי אומינו א'–ה'; טאלה א'–ד' כמו קודם (אנזו/ג'ונתן). פטל חופש ו'+ש' (ביקש) → במוצ"ש הילארי בטאלה.
//   גיל 26/09 בלילה: מחר (א' 27/09) ג'רמי בערב באומינו, פטל מבוטל באותו יום. בוקר אומינו א' — חסר (מסומן).
...
const P = "Paseo", U = "Umino", T = "Tala", U_GAP = "Umino – חסר שוטף בוקר";

type Row = [number, number, number | null, string, string];
const ROWS: Row[] = [
  [0, B, W.JONATHAN, "10:00", P], [0, B, null, "11:00", U_GAP],
  [0, E, W.HILLARY, "17:00", P], [0, E, W.ENZO, "18:00", T], [0, E, W.JEREMY, "18:00", U],
