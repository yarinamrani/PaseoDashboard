...
// שוטפים 27/09–03/10 — התוכנית של גיל (26/09): אומינו = סרילנקי בבקרים + ג'רמי בערבים.
//   פטל יוצא מאומינו: טאלה א'–ד' 18:00, פסאו ה' 17:00, חופש ו'+ש' (ביקש).
//   ג'ונתן בג'+ד' בבוקר באומינו לסידור מחסנים (בקשת גיל). מוצ"ש: הילארי בטאלה.
//   לסרילנקי אין עדיין משתמש → תא ריק עם הערה עד שיגיע טלפון.
//   ירין 26/09: ג'ונתן ↔ אנזו — ג'ונתן מחסנים באומינו א'+ב' ופסאו ג'+ד'; אנזו פסאו א'+ב'.
//   ⚠ אנזו סגר פסאו במוצ"ש 26/09 (16:00) ופותח א' 10:00 — אין חלופה, מסומן לירין.
//   ירין 26/09: אנזו נוסף לפסאו בערב בג' (18:00, עם הילארי); בה' ג'ונתן פותח את פסאו ואנזו בערב עם פטל (18:00).
//   ⚠ ג'ונתן עובד 7 ימים.
// Reconcile מול ROWS. לא מפרסם.
...
const ROWS: Row[] = [
  [0, B, W.ENZO, "10:00", P], [0, B, null, "11:00", SL], [0, B, W.JONATHAN, "10:00", STORE],
  [0, E, W.HILLARY, "17:00", P], [0, E, W.PATEL, "18:00", T], [0, E, W.JEREMY, "18:00", U],

  [1, B, W.ENZO, "10:00", P], [1, B, null, "10:00", SL], [1, B, W.JONATHAN, "10:00", STORE],
  [1, E, W.HILLARY, "17:00", P], [1, E, W.PATEL, "18:00", T], [1, E, W.JEREMY, "18:00", U],

  [2, B, W.JONATHAN, "10:00", P], [2, B, null, "10:00", SL],
  [2, E, W.HILLARY, "17:00", P], [2, E, W.ENZO, "18:00", P], [2, E, W.PATEL, "18:00", T], [2, E, W.JEREMY, "18:00", U],

  [3, B, W.JONATHAN, "10:00", P], [3, B, null, "10:00", SL],
  [3, E, W.HILLARY, "17:00", P], [3, E, W.PATEL, "18:00", T], [3, E, W.JEREMY, "18:00", U],

  [4, B, W.JONATHAN, "10:00", P], [4, B, null, "10:00", SL],
  [4, E, W.PATEL, "17:00", P], [4, E, W.ENZO, "18:00", P], [4, E, W.TONY, "19:00", T], [4, E, W.JEREMY, "18:00", U],

  [5, B, W.JONATHAN, "08:00", P], [5, B, null, "10:00", SL], [5, B, W.ENZO, "13:00", P],
  [5, E, W.HILLARY, "17:00", P], [5, E, W.TONY, "19:00", P],

  [6, B, W.JONATHAN, "08:00", P],
  [6, E, W.ENZO, "16:00", P], [6, E, W.HILLARY, "19:30", T], [6, E, W.JEREMY, "19:30", U],
];
